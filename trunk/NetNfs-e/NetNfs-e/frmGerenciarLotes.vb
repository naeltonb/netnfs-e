    ...
    Public Sub CarregarLista()
        ...
        Try
            ...
            For Each _arquivo In arquivos
                ...
                subItem = New ListViewItem.ListViewSubItem
                subItem.Text = CType(_docXml.GetElementsByTagName("NumeroLote").Item(0).InnerText, Integer)
                item.SubItems.Add(subItem)
                    ...
                    Select Case cmd
                        ...
                        Case "Importar"
                            ...
                            If item.SubItems(2).Text = "Processado com sucesso" Or item.SubItems(2).Text = "Notas importadas" Then
                                ...
                                ServicoConsultarLote_Envio(item)
                            Else
                                MsgBox("Para essa opção o Status do lote deve ser = Processado com sucesso  ou Notas importadas", vbExclamation, "Atenção")
                            End If
