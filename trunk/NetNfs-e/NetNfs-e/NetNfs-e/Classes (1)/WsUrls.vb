Module WsUrls
    ...
    Public Function UrlWebService(ByVal Municipio As MunicipioDeEmissao, ByVal Ambiente As Ambiente) As String
    ...
    'NameSpaces
    Public Function UrlNameSpace(ByVal Municipio As MunicipioDeEmissao) As String
    ...
    Public Function UrlXsd(ByVal Municipio As MunicipioDeEmissao, ByVal Servico As ServicoWebService) As ListaUrl
